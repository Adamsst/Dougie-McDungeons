    ...
    public partial class Inventory : Form
    {
        ...
        private void equipButton_Click(object sender, EventArgs e)
        {
            if (equipmentListBox.SelectedIndex >= 0)
            {
                ...
                Form1.UpdateForm.NewFormEvent(1, "You have equipped " + _equipList[equipmentListBox.SelectedIndex].name + ".");
            }
        }
        ...
        private void imbueButton_Click(object sender, EventArgs e)
        {
            if (equipmentListBox.SelectedIndex >= 0 && essenceListBox.SelectedIndex >= 0)
            {
                if (_equipList[equipmentListBox.SelectedIndex].location == _essenceList[essenceListBox.SelectedIndex].location)
                {
                    ...
                    _equipList[equipmentListBox.SelectedIndex].secondName = _essenceList[essenceListBox.SelectedIndex].suffixName;
                    _equipList[equipmentListBox.SelectedIndex].name = _equipList[equipmentListBox.SelectedIndex].firstName + " " + _equipList[equipmentListBox.SelectedIndex].secondName;
                    equipmentListBox.Items[equipmentListBox.SelectedIndex] = _equipList[equipmentListBox.SelectedIndex].name;
                    _essenceList.RemoveAt(essenceListBox.SelectedIndex);
        ...
        private void deleteEquip_Click(object sender, EventArgs e)
        {
            if (equipmentListBox.SelectedIndex >= 0)
            {
                Form1.UpdateForm.NewFormEvent(1, "You have abandoned " + _equipList[equipmentListBox.SelectedIndex].name + ".");
        ...
        private void deleteEssence_Click(object sender, EventArgs e)
        {
            if (essenceListBox.SelectedIndex >= 0)
            {
                Form1.UpdateForm.NewFormEvent(1, "You have abandoned " + _essenceList[essenceListBox.SelectedIndex].name + ".");
        ...
        private void unequipButton_Click(object sender, EventArgs e)
        {
            if (equipmentListBox.SelectedIndex >= 0)
            {
                ...
                {
                    case "Head":
                        if (_player.head == _equipList[equipmentListBox.SelectedIndex])
                        {
                            Form1.UpdateForm.NewFormEvent(1, "You have unequipped " + _equipList[equipmentListBox.SelectedIndex].name + ".");
                            _player.head = null;
                        }
                        break;
                    case "Chest":
                        if (_player.chest == _equipList[equipmentListBox.SelectedIndex])
                        {
                            Form1.UpdateForm.NewFormEvent(1, "You have unequipped " + _equipList[equipmentListBox.SelectedIndex].name + ".");
                            _player.chest = null;
                        }
                        break;
                    case "Legs":
                        if (_player.legs == _equipList[equipmentListBox.SelectedIndex])
                        {
                            Form1.UpdateForm.NewFormEvent(1, "You have unequipped " + _equipList[equipmentListBox.SelectedIndex].name + ".");
                            _player.legs = null;
                        }
                        break;
                    case "Hands":
                        if (_player.hands == _equipList[equipmentListBox.SelectedIndex])
                        {
                            Form1.UpdateForm.NewFormEvent(1, "You have unequipped " + _equipList[equipmentListBox.SelectedIndex].name + ".");
                            _player.hands = null;
                        }
                        break;
                    case "Feet":
                        if (_player.feet == _equipList[equipmentListBox.SelectedIndex])
                        {
                            Form1.UpdateForm.NewFormEvent(1, "You have unequipped " + _equipList[equipmentListBox.SelectedIndex].name + ".");
                            _player.feet = null;
                        }
                        break;
                    case "Weapon":
                        if (_player.weapon == _equipList[equipmentListBox.SelectedIndex])
                        {
                            Form1.UpdateForm.NewFormEvent(1, "You have unequipped " + _equipList[equipmentListBox.SelectedIndex].name + ".");
                            _player.weapon = null;
                        }
